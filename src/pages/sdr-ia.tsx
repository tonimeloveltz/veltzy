...
import { useFirstLeadOfPipeline } from '@/hooks/use-leads'
...
const SdrIaPage = () => {
  ...
  // Lead de teste para o sandbox: primeiro lead REAL do pipeline selecionado,
  // escopado pela empresa atual (evita id hardcoded de outra empresa -> mismatch).
  const { data: testLead } = useFirstLeadOfPipeline(pipelineId)
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="sandbox" className="mt-6">
          {!agentProfile ? (
            ...
            <Card>
              <CardContent className="py-12 text-center text-sm text-muted-foreground">
                Nenhum lead neste pipeline para testar. Crie um lead de teste no pipeline
                selecionado para usar o sandbox.
              </CardContent>
            </Card>
          ) : (
